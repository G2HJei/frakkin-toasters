...
public record ActivateRaidersEvent() implements Event {
    ...
    public Followup apply(Game game) {
        ...
        val raiderFollowups = buildRaiderActivationEvents(raiders, galactica);
        return Followup.all(raiderFollowups);
    }
    ...
    private static Event[] buildRaiderActivationEvents(List<Raider> raiders, GalacticaBoard galactica) {
