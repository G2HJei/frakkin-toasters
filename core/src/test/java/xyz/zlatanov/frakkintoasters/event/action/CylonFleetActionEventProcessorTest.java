...
class CylonFleetActionEventProcessorTest extends EventProcessorTestHarness<CylonFleetActionEvent> {

    @Override
    protected EventProcessor<CylonFleetActionEvent> eventProcessor() {
        return new CylonFleetActionEventProcessor();
    }
